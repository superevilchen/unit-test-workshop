...
import testingil.unittesting.examples.demos.d03.clean.Distance;
import testingil.unittesting.examples.demos.d03.clean.DistanceProvider;
import testingil.unittesting.examples.demos.d03.clean.Location;
...
class NavigatorUnitTests {
	...
	void when_created_distance_is_always_zero() {
		...
		nav = new Navigator(mockDistService);
